Public Class AdminDashboard
    ...
    Private Sub AdminDashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        max()
        Form1.Hide()
        UserControl_admindashboard1.Width = 500
        UserControl_admindashboardnontabular1.Width = 500
        UserControl_admindashboard1.Height = 500
        UserControl_admindashboardnontabular1.Height = 500
        Me.WindowState = FormWindowState.Maximized
